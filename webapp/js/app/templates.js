define(['text!templates/credits.html',
    ...
    'text!templates/draw_winner_selection2.txt',
    'text!templates/draw_arrow_selection2.txt',
    ...
    function(credits, overlay, popup, popup_simple, 
             feature_click_sql, permalink_sql, draw1_sql, draw_winner2_sql,
             draw_arrow2_sql, d3_geom_sql, d3_winner_sql, d3_diff_sql) {
        return {
            credits: credits,
            overlay: overlay,
            popup: popup,
            ...
            draw1_sql: draw1_sql,
            draw2_w_sql: draw_winner2_sql,
            draw2_a_sql: draw_arrow2_sql,
